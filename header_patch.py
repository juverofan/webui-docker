        with gr.Box(visible=is_spaces):
            if(is_spaces and is_shared_ui):
                ...
                <div class="gr-prose" style="max-width: 80%">
                    <p>🚧 (WIP) Automatic1111 Stable Diffusion Web UI on 🤗 | v1.6 | Running model: andite/anything-v4.0 - anything-v4.5-pruned</p>
                    ...
                    <p>📝 How to add private model or embed? 📺 Tutorial Video: <a href="https://youtu.be/o2bSILOcL2U" style="target=" _blank"="">https://youtu.be/o2bSILOcL2U</a> 🐣 Please follow me for new updates <a href="https://twitter.com/camenduru" style="target=" _blank"="">https://twitter.com/camenduru</a> </p>
                </div>
                ''')
            elif(is_spaces):
                import torch
