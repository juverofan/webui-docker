        with gr.Box(visible=is_spaces):
            if(is_spaces and is_shared_ui):
                ...
                if(not torch.cuda.is_available()):
                    gr.HTML(f'''
                    <div>
                        <p>🚧 (WIP) Private Automatic1111 Stable Diffusion Web UI on 🤗 | v1.6</p>
                        <p>This Space is currently running on CPU, this WebUI may not run on CPU 🥶, you can upgrade for a GPU <a href="https://huggingface.co/spaces/{os.environ['SPACE_ID']}/settings" style="text-decoration: underline" target="_blank">in the Settings tab</a>&nbsp;&nbsp;<a style="display:inline-block" href="https://github.com/camenduru/stable-diffusion-webui-colab" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"></a>&nbsp;&nbsp;<a style="display:inline-block" href="paypal.me/topvl" target="_blank"><img style="margin: 0" alt="Buy a Coffee" src="https://badgen.net/badge/buy/a%20coffee/green?icon=kofi"></a></p> 
