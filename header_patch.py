        with gr.Box(visible=is_spaces):
            if(is_spaces and is_shared_ui):
                ...
                <div class="gr-prose" style="max-width: 80%">
                    <p>Automatic1111 Stable Diffusion Web UI | v1.6 | Running model: andite/anything-v4.0 - anything-v4.5-pruned</p>
                ...
                if(not torch.cuda.is_available()):
                    gr.HTML(f'''
                    <div class="gr-prose" style="max-width: 80%">
                        <p>Private Automatic1111 Stable Diffusion Web UI | v1.6</p>
