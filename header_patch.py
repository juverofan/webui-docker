        with gr.Box(visible=is_spaces):
            if(is_spaces and is_shared_ui):
                ...
                <div class="gr-prose" style="max-width: 80%">
                    ...
                    <p>📝 How to add private model or embed? 📺 Tutorial Video: Coming Soon... 🐣 Please follow me for new updates <a href="https://twitter.com/camenduru" style="target=" _blank"="">https://twitter.com/camenduru</a> </p>
                </div>
                ''')
            elif(is_spaces):
                import torch
